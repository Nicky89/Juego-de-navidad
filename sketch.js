...
var backgroundImg;
function preload(){
  polygon_img=loadImage("esfera.png");
...
function setup() {
  ...
  Grinch = createSprite(30,70,10,40);
  ...
  polygon = Bodies.circle(50,150,40);
...
function draw() {
  ...
  textSize(20);
  fill("lightyellow");
  text("Presiona la barra espaciadora para otra opurtunidad",300,30);
  textSize(10);
  ground.display();
  stand1.display();
  stand2.display();
